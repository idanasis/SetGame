...
class TableTest {
    ...
    void placeToken() {
        ...
        assertTrue(table.slotsToPlayers.get()[0][0]);
    }
    ...
    void removeToken() {
        ...
        assertFalse(table.slotsToPlayers.get()[0][0]);
    }

    @Test
    void playerFinished() {
        table.playerFinished(0);
        int expected = 0;
        assertEquals(expected,table.finished.get().removeFirst());
    }
